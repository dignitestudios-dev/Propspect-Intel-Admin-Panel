          ...
          >
            <div>
             <div className="w-full rounded-lg px-2 gap-1 py-2 text-sm placeholder-white/60 bg-white/10 border border-white/20 flex flex-col items-start justify-start relative">
              <label className="text-white text-start text-[14px] font-extralight ">Password</label>
                <input
                  type={isPasswordVisible ? "text" : "password"}
                  defaultValue="password"
                  className="w-full rounded-lg  text-[14px] font-[500] placeholder-white/60 text-[#fff] bg-transparent focus:outline-none "
                />
                <button
            ...
            <div className="text-left">
              <NavLink to="/auth/rest-password" className="text-sm font-medium text-white underline">
                Forgot Password?
              </NavLink>
            </div>

            <div>
              <button onClick={()=> navigate("/auth/login")} className="w-full py-3 rounded-md bg-[#0b89c6] text-white font-[500] shadow-inner">
Rest Password
              </button>
            </div>
          </form>
